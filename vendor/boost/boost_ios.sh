...
BOOST_LIBS="${BOOST_LIBS:-date_time filesystem log program_options system test thread}"
...
TARBALLDIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
...
PREFIXDIR=${PREFIXDIR:-$IOSOUTPUTDIR/prefix}
