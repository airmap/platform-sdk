...
airmap::qt::Status::Status(const std::shared_ptr<Dispatcher>& dispatcher, const std::shared_ptr<Client>& client)
...
void airmap::qt::Status::get_status_by_polygon(const GetStatus::Parameters& parameters,
