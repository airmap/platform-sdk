...
constexpr const char* component{"search-rulesets"};
}  // namespace

cmd::SearchRulesets::SearchRulesets()
    : cli::CommandWithFlagsAndAction{"search-rulesets", "",
                                     ""} {
  ...
  action([this](const cli::Command::Context& ctxt) {
    ...
    context->create_client_with_configuration(
        config, [this, &ctxt, context](const ::airmap::Context::ClientCreateResult& result) {
          ...
          auto handler = [this, &ctxt, context, client](const RuleSets::Search::Result& result) {
            if (result) {
              ...
              try {
                ...
                log_.errorf(component, "failed to search for rulesets: %s", e.what());
              } catch (...) {
                log_.errorf(component, "failed to search for rulesets");
              }
              context->stop(::airmap::Context::ReturnCode::error);
              return;
            }
          ...
          client->rulesets().search(params_, handler);
