...
#ifndef AIRMAP_REST_OIDC_AUTHENTICATOR_H_
#define AIRMAP_REST_OIDC_AUTHENTICATOR_H_
...
class Authenticator : public airmap::Authenticator {
 public:
  ...
  explicit Authenticator(const std::shared_ptr<net::http::Requester>& requester);
...
#endif  // AIRMAP_REST_OIDC_AUTHENTICATOR_H_
